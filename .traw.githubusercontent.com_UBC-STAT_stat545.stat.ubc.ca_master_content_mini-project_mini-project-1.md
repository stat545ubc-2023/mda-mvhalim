...
original_price and discounted_price. Then I presented the data to only
correlate the price related variables with the game title. We can see
how in each title how much the price jumped or dropped after release.
...
of the dataset (And also today is the day I learned some people will buy
games for more than 300 dollars! )
...
In this analysis, lets see the distribution of original prices for games
below \$200.
