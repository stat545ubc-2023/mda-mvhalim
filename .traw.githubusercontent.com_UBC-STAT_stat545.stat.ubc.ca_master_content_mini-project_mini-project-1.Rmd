...
<!-------------------------- Start your work below ---------------------------->
## Task 2.2
**First lets have the steam_games dataset on display with the head() function for easy reference**
```{r}
head(steam_games)
```
...
**In this analysis, lets see the distribution of original prices for games below $200.**
